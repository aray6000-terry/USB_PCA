...
系統內建預設角色，可直接使用以下帳號密碼登入測試：

| 帳號 | 預設密碼 | 角色 | 說明 |
| :--- | :--- | :--- | :--- |
| `terry` | `terry123` | **Admin** | 系統總監 / 超級管理者 |
| `admin` | `admin123` | **Admin** | 系統管理員 |
| `accountant` | `acc123` | **Accountant** | 財務部會計審核員 |
| `employee` | `emp123` | **Employee** | 業務部同仁 |
| `designer` | `emp123` | **Employee** | 設計研發組同仁 |
